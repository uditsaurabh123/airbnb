        ...
        <nav className="bg-blue-700 border-b border-blue-500">
            ...
            <div className="hidden" id="mobile-menu">
                <div className="space-y-1 px-2 pb-3 pt-2">
                    ...
                    >Add Property</Link>
                    <button
                        className="flex items-center text-white bg-amber-400 hover:bg-amber-300 hover:text-white rounded-md px-3 py-2 my-4"
                    >
                        <FaGoogle className='mr-2 text-white h-4 w-4' />
                        <span>Login or Register</span>
                    </button>
                </div>
            </div>
